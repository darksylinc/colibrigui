...
static Colibri::Window *mainWindow = 0;
static Colibri::Window *vertWindow = 0;
static Colibri::Window *fullWindow = 0;
static Colibri::Button *button0 = 0;
static Colibri::Button *button1 = 0;
static Colibri::Spinner *spinner0 = 0;
static Colibri::Checkbox *checkbox0 = 0;
static Colibri::ToggleButton *toggleButton = 0;
static Colibri::Editbox *editbox0 = 0;
static Colibri::Progressbar *progressBar0 = 0;
static Colibri::Progressbar *progressBar1 = 0;
static Colibri::Slider *slider1 = 0;
static Colibri::Slider *slider2 = 0;
static Colibri::Label *sliderLabel = 0;

static Colibri::GraphChart *graphChart = 0;

static Colibri::Window *overlapWindow1 = 0;
static Colibri::Window *overlapWindow2 = 0;
static Colibri::Button *orderButtonBack = 0;
static Colibri::Button *orderButtonFront = 0;
static Colibri::Window *innerOverlapWindow1 = 0;
static Colibri::Window *innerOverlapWindow2 = 0;
static Colibri::Button *innerOverlapButton1 = 0;
static Colibri::Button *innerOverlapButton2 = 0;
static Colibri::Button *innerToggleOrder = 0;
...
//-----------------------------------------------------------------------------------
Colibri::ColibriManager *ColibriGuiGameState::getColibriManager()
{
...
void ColibriGuiGameState::createScene01( void )
{
	...
	checkbox0->getButton()->getLabel()->setTextHorizAlignment( Colibri::TextHorizAlignment::Natural );
	layout->addCell( checkbox0 );
	...
	Colibri::LayoutLine layoutOverlapping( colibriManager );
...
#if 0
		//Colibri::LayoutLine layout( colibriManager );
		Colibri::LayoutMultiline layout( colibriManager );
		//Colibri::LayoutTableSameSize layout( colibriManager );
